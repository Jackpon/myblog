...
- **二叉树性质**
  ...
  - *性质1*：非空二叉树的第i(i≥1)层上最多有<img src="http://chart.googleapis.com/chart?cht=tx&chl= 2^{i-1}" style="border:none;">个结点；

  - *性质2*：深度为h (h≥1)的非空二叉树最多有<img src="http://chart.googleapis.com/chart?cht=tx&chl= 2^h - 1" style="border:none;">个结点；

  - *性质3*：非空二叉树上的终端结点（叶结点）等于双分支结点数加1： 

         n0 =  n2 + 1

  - *性质4*： 具有n（n>0）个结点的完全二叉树的深度<img src="http://chart.googleapis.com/chart?cht=tx&chl= h = log_2n + 1" style="border:none;">
